...
#include <memory>
#include "../../../MLP/View_module/testing.h"
...
QT_MOC_LITERAL(24, 0), // ""
QT_MOC_LITERAL(25, 3), // "Run"
QT_MOC_LITERAL(29, 9) // "Terminate"

    },
    "s21::Testing\0BackSignal\0\0Run\0Terminate"
};
...
void s21::Testing::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Testing::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Testing::Run)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (Testing::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Testing::Terminate)) {
                *result = 2;
                return;
            }
        }
...
, QtPrivate::TypeAndForceComplete<Testing, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>
...
// SIGNAL 1
void s21::Testing::Run()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void s21::Testing::Terminate()
{
