...
Testing::Testing(QWidget *parent) : QWidget(parent), ui_(new Ui::Testing) {
  ui_->setupUi(this);
  ...
  connect(ui_->btn_open_testing_file, &QPushButton::clicked, this,
          &Testing::OpenDatasetFile);
  connect(ui_->btn_back, &QPushButton::clicked, this, &Testing::BackSignal);
  connect(ui_->btn_test_run, &QPushButton::clicked, this,
          &Testing::StartTesting);
  connect(ui_->btn_test_terminate, &QPushButton::clicked, this,
          &Testing::StopTesting);
